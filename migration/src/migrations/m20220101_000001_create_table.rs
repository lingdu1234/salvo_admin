...
use super::super::db_utils::{
    create_one_table as Cot, create_table_index as Cti, drop_one_table as Dot, init_data,
};
...
async fn create_index(m: &SchemaManager<'_>) -> Result<(), DbErr> {
    ...
    Cti(
        m,
        sys_dict_data::Entity,
        "d_type_tp",
        vec![sys_dict_data::Column::DictType],
        "i",
    )
    .await?;
    Cti(
        m,
        sys_dict_type::Entity,
        "d_data_tp",
        vec![sys_dict_type::Column::DictType],
        "i",
    )
    .await?;
    ...
    Cti(
        ...
        sys_role_api::Entity,
        "ra_api_rid",
        vec![sys_role_api::Column::RoleId],
        "i",
    )
    .await?;
    ...
    Cti(
        m,
        sys_role_dept::Entity,
        "rd_rid",
        vec![sys_role_dept::Column::RoleId],
        "i",
    )
    .await?;
    Cti(
        ...
        sys_role_dept::Entity,
        "rd_dpid",
        vec![sys_role_dept::Column::DeptId],
        "i",
    )
    .await?;
    ...
    Cti(
        m,
        sys_user_online::Entity,
        "uo_uid",
        vec![sys_user_online::Column::UId],
        "i",
    )
    .await?;
    Cti(
        ...
        sys_user_online::Entity,
        "uo_tid",
        vec![sys_user_online::Column::TokenId],
        "i",
    )
    .await?;
    ...
    Cti(
        ...
        "ur_uid",
        vec![sys_user_role::Column::UserId],
        "i",
    )
    .await?;
    Cti(
        ...
        sys_user_role::Entity,
        "ur_rid",
        vec![sys_user_role::Column::RoleId],
        "i",
    )
    .await?;
    ...
    Cti(
        ...
        sys_menu::Entity,
        "sm_po",
        vec![sys_menu::Column::Pid, sys_menu::Column::OrderSort],
        "u",
    )
    .await?;
    Cti(
    ...
    Cti(
        m,
        test_data_scope::Entity,
        "td_uid",
        vec![test_data_scope::Column::CreatedBy],
        "i",
    )
    .await?;
